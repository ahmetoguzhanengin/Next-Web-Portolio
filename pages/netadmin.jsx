  ...
  return (
    <div className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
            ...
            <Image className='absolute z-1' layout='fill' objectFit='cover' src={NetAdmin} alt=''/>
            <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] rigth-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
                <h2 className='py-2'>Asp.Net İle Admin Paneli</h2>
        ...
        <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
            <div className='col-span-4'>
                ...
                <p className='mt-4'>
                Asp.Net kullanarak tasarlamış olduğum bu projede kendi html css bilgimi güncel tutmak ve Asp.Net MVC yapısını pekiştirmek amacı ile basit bir pratik yapmış bulunmaktayım. Adin paneli sayesinde ana sayfadaki resminizi güncelleyebilir, metinleri değiştirebilir, ikonları düzenleyebilir ve linkleme yapabilirsiniz. Projeyi incelemek için github hesabımı ziyaret edebilirsiniz.
                </p>
                <a
