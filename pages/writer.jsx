...
import Writer from  '../public/assets/projects/WriterDashboard.PNG';
  ...
  return (
    <div className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
            ...
            <Image className='absolute z-1' layout='fill' objectFit='cover' src={Writer} alt=''/>
            <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] rigth-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
                <h2 className='py-2'>Asp.Net Core 5.0 Writer Dashboard</h2>
        ...
        <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
            <div className='col-span-4'>
                ...
                <p className='mt-4'>
                Asp.Net Core 5.0 ile yapılmış writer panelinde yeni blog yazısı yazabilir, blog yazılarınızda düzenleme yapabilir, diğer kullanıcılarla mesajlaşabilir ve bildirimlerinizi takip edebilirsiniz. Proje ile ilgili tüm detaylara github hesabımdan ulaşabilirsiniz.
                </p>
                <a
