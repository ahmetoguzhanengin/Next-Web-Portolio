    ...
    <div className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
            ...
            <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] rigth-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
                <h2 className='py-2'>Asp.Net Core 5.0 Blog Projesi</h2>
        ...
        <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
            <div className='col-span-4'>
                ...
                <p className='mt-4'>
                Asp.Net Core 5.0 ile yapılmış kendi içinde admin ve yazar kontrol paneline sahip aynı zamanda mesajlaşma mekanizması bulunan, kategorilere göre blog yazısı yazabildiğiniz ve blog yazılarını puanlayıp yorum atabildiğiniz web platformu projesidir. Admin ve writer kontrol panelinde birçok özellik bulunmaktadır. Proje yapımı sırasında birçok teknolokiden yararlanılmıştır. Proje ile ilgili tüm detaylara github hesabımdan ulaşabilirsiniz.
                </p>
                <a
