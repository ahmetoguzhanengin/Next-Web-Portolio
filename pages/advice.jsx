    ...
    <div className='w-full'>
        ...
        <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
            <div className='col-span-4'>
                ...
                <p className='mt-4'>
                React kullanılarak bir challenge için yapılmış bu projede ekrana her bastığınızda random bir tavsiye üretmektedir. Css için Tailwind kullanılmıştır. Basit ve eğlenceli bir projedir. İncelemek isterseniz GitHub hesabımdan inceleyebilirsiniz.  
                </p>
                <a
                    href='https://github.com/ahmetoguzhanengin/React-Mini-RandomAdvice-Project'
                    target='_blank'
